...
var beginReceiveData = function () {
  ...
  userApi.emitter.on("Login Succeed", function(data) {
    userApi.childProcess.send({event: EVENTS.ReqQryMonitorObjectTopic, reqField: reqMonitorObjectTopicData })
  })

  var treeviewData1 = []
  userApi.emitter.on(EVENTS.RspQryMonitorObjectTopic, function (data) {
